 ...
 */
class Atr_Categories_Manager_Admin {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/atr-categories-manager-admin.css', array(), $this->version, 'all' );
